  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full px-4 py-2 bg-black/40 border-b-2 border-white/30 text-white hover:border-white transition-all text-left rounded-lg"
      >
        {fileName || "Pilih file..."}
      </button>
      <input
...
export default function AuthForm({ type = "login" }: AuthFormProps) {
      ...
      if (type === "register") {
        ...
        if (formData.role === "client") {
          ...
          if (formData.certification)
            secureImageUrlCloudinary = await UploadImage(
  ...
  const renderLoginForm = () => (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="relative">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-6 py-3 bg-white/15 backdrop-blur-md border border-white/30 text-white focus:border-blue-400/60 outline-none transition-all placeholder-white/50 rounded-xl hover:border-white/40 font-sans pl-12"
      ...
      <button
        type="submit"
        className="w-full bg-gradient-to-r from-blue-600 to-blue-400 text-white py-3.5 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 font-medium"
      >
        Masuk
        ...
        <div className="grid grid-cols-2 gap-6 mt-6 pt-6 border-t border-white/10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <input
              ...
              className="w-full px-6 py-3 bg-white/15 backdrop-blur-md border border-white/30 text-white focus:border-blue-400/60 outline-none transition-all placeholder-white/50 rounded-xl hover:border-white/40 font-sans"
              placeholder="Masukkan area spesialisasi"
            />
          </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      <div className="w-full max-w-5xl flex gap-6 items-stretch relative z-10 py-20">
        ...
        <div
          className={`flex-1 ${type === "register" ? "max-w-4xl mx-auto" : ""}`}
        >
          <div
            className="
                        bg-white/10 
              ...
              <p className="text-white">
                {type === "login" ? (
                  <>
                    ...
                    <Link
                      href="/register"
                      className="text-blue-200 hover:text-blue-300 font-medium"
                    >
                      Daftar
                    </Link>
                  </>
