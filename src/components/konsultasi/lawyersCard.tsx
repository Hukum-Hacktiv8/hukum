  ...
  const lawyers: Lawyer[] = [
    {
      ...
      image: "https://images.pexels.com/photos/4427622/pexels-photo-4427622.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      ...
      fee: 50000,
      skill: "Melayani Konsultasi Hukum Pidana, Konsultasi Hukum Perdata, Konsultasi hukum korporasi",
    },
    {
      id: "2",
    ...
    },
    {
      ...
      fee: 50000,
      skill: "Melayani Konsultasi Hukum Ketenagakerjaan, Konsultasi Hukum Perkawinan",
    },
  ];
          ...
          <div key={lawyer.id} className="card bg-base-100 w-96 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-center p-5">
                <button onClick={() => setSelectedLawyerId(lawyer.id)} aria-pressed={selectedLawyerId === lawyer.id} className={`btn ${selectedLawyerId === lawyer.id ? "bg-gray-400 text-white" : ""} hover:bg-gray-400 active:scale-95 transition-all duration-200 ease-in-out`}>
                  Booking Appointment
                </button>
              </div>
            </div>
