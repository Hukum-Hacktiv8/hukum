          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                Dapatkan Notifikasi Terkini
              </h3>
              <p className="text-gray-400">
                Berlangganan untuk mendapatkan informasi terbaru mengenai
                layanan kami
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6">
              Solusi hukum modern dengan kombinasi pengalaman & teknologi AI
              untuk hasil terbaik. Kami berkomitmen memberikan layanan hukum
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-t border-slate-800 mb-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-400">
              South Tower, Green Office Park 1, Jl. BSD Green Office Park 6th
              Floor, Sampora, Kec. Cisauk, Kabupaten Tangerang, Banten 15345
            </span>
          </div>
          <div className="flex items-center gap-3">
