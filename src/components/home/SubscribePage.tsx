...
const plans: Plan[] = [
  ...
  },
  {
    ...
    color: "from-[#B8860B] to-[#DAA520]",
    popular: true,
    features: ["Semua Fitur Paket Dasar", "Konsultasi Hukum Prioritas", "Peninjauan Dokumen Tanpa Batas", "Dukungan Email & Telepon Prioritas", "Template Hukum Premium", "Dukungan Chat Prioritas 24/7", "Video Call dengann Pengacara", "Chat with AI Assistant 24/7"],
  },
];
