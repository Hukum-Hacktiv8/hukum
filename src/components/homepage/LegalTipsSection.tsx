...
const tips = [
  {
    image: "https://images.hukumonline.com/frontend/lt515b7ec90fe0c/lt64df56656b9b2.jpg",
  ...
  {
    image: "https://images.hukumonline.com/frontend/lt66a12b77d0258/lt66a12c7c1762d.jpg",
    ...
    <section className="py-20 bg-slate-900">
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          <h2 className="text-4xl font-lora text-white mb-4">Legal Tips & Insights</h2>
          <p className="text-white/80 max-w-2xl mx-auto">Stay informed with our latest legal articles and tips</p>
        </motion.div>
              ...
              <Link href={tip.link} className="block">
                ...
                <div className="p-4">
                  <div className="bg-slate-900/90 backdrop-blur-sm rounded-lg p-4">
                    <h2 className="text-lg font-semibold text-white group-hover:text-blue-300 transition-colors line-clamp-2">{tip.title}</h2>
                  </div>
                </div>
                {/* Overlay gradient */}
