        ...
        {selectedContact ? (
          <>
            <div className="p-4 bg-slate-800/90 backdrop-blur-sm border-b border-slate-700 flex justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="p-2.5 bg-blue-600/80 hover:bg-blue-600 text-white rounded-lg flex items-center justify-center transition-colors"
                >
            ...
            <form
              ...
              className="p-4 bg-slate-800/90 backdrop-blur-sm border-t border-slate-700"
            >
              <div className="flex gap-2">
                <input
                  type="text"
                  ...
                  className="flex-1 bg-slate-700/50 rounded-lg px-4 py-2.5 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                />
                <button
                  type="submit"
                  className="p-2.5 bg-blue-600/80 hover:bg-blue-600 rounded-lg transition-colors"
                >
