          ...
          <aside className="col-span-12 lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-800 rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={idx}
                    className="px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-gray-300 hover:text-white rounded-lg cursor-pointer transition-all duration-200 ease-in-out"
                  >
                    {topic}
                  </span>
                ))}
            ...
            <div className="bg-slate-800 rounded-xl p-6">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Dapatkan update hukum terbaru & analisis terbaru ke inbox
              </p>
