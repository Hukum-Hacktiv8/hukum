...
export default function NewsArticle({ params }: { params: { id: string } }) {
  const [article, setArticle] = useState<Article>({
    ...
    content: `
Dalam perkembangan terbaru dunia hukum bisnis Indonesia, perubahan UU PT membawa sejumlah implikasi penting yang perlu dicermati pelaku usaha.
...
Dampak Terhadap Startup dan UKM:
...
Perubahan UU PT ini membuka peluang besar bagi pertumbuhan startup dan UKM di Indonesia. Namun, diperlukan pemahaman dan persiapan yang matang untuk memaksimalkan manfaatnya.
        `,
    author: {
