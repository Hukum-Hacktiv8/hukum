  ...
  const services = [
    {
      ...
      title: "Hukum Pidana",
      description:
        "Pembelaan kasus pidana dengan pendekatan yang komprehensif dan strategis",
    },
    {
      icon: <IoBusinessOutline className="w-8 h-8" />,
      title: "Hukum Bisnis",
      description:
        "Konsultasi dan pendampingan legal untuk kebutuhan bisnis dan korporasi",
    },
    {
      icon: <IoHomeOutline className="w-8 h-8" />,
      title: "Hukum Properti",
      description: "Penanganan sengketa properti dan perizinan pembangunan",
    },
    {
      icon: <IoPeopleOutline className="w-8 h-8" />,
      title: "Hukum Keluarga",
      description:
        "Mediasi dan penyelesaian masalah keluarga dengan pendekatan yang sensitif",
    },
    {
      icon: <IoDocumentTextOutline className="w-8 h-8" />,
      title: "Hukum Kontrak",
      description: "Penyusunan dan review kontrak untuk kepastian hukum bisnis",
    },
    {
      icon: <IoShieldOutline className="w-8 h-8" />,
      title: "Hukum Perlindungan",
      description: "Perlindungan hak cipta, paten dan kekayaan intelektual",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Kami menyediakan berbagai layanan hukum yang disesuaikan dengan
