export default function StatsSection() {
  const stats = [
    ...
    },
    {
      ...
      description:
        "Menangani berbagai kasus dengan tingkat keberhasilan tinggi",
    },
    {
        number: "50+",
      label: "Pengacara Profesional",
      description: "Tim ahli hukum dengan spesialisasi beragam",
    },
    {
      number: "24/7",
      label: "Dukungan AI",
      description: "Analisis kasus awal dan konsultasi dengan AI assistant",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Kami berkomitmen memberikan layanan hukum terbaik dengan kombinasi
            pengalaman dan teknologi modern
          </p>
        </div>
