  ...
  const tips = [
    {
      ...
      title: "5 Hal Penting yang Harus Ada di Kontrak Bisnis",
      preview:
        "Pelajari elemen kunci yang wajib ada dalam kontrak bisnis untuk melindungi kepentingan perusahaan Anda...",
      image:
    ...
    },
    {
      ...
      preview:
        "Langkah-langkah penting yg perlu diketahui ketika Anda atau kerabat menghadapi kasus pidana...",
      image:
        "https://images.unsplash.com/photo-1453945619913-79ec89a82c51?q=80&w=2070",
    },
    {
      date: "26 Feb 2024",
      ...
      preview:
        "Membahas perubahan signifikan dalam UU ITE terbaru & dampaknya terhadap pengguna internet...",
      image:
          ...
          {tips.map((tip, index) => (
            ...
            >
              ...
              <div className="p-6 pt-2">
                ...
                <p className="text-gray-400 text-sm mb-4">{tip.preview}</p>
