...
export default function KonsultasiPage() {
  ...
  function handleBooking() {
    const lawyerId = "676da8a4ab88bd555d8103b6";
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-4 mb-4">
              {["Wed 3", "Thu 4", "Fri 5", "Sat 6", "Sun 7", "Mon 8", "Tue 9"].map((day) => (
                <button key={day} className="btn btn-outline rounded-full px-4 py-1 text-sm font-medium">
                  {day}
                </button>
              ))}
            </div>
            <div className="flex flex-wrap gap-4">
              {["05:00 PM", "06:00 PM", "06:30 PM", "07:00 PM", "07:30 PM", "08:00 PM"].map((time) => (
                <button key={time} className="btn btn-outline rounded-full px-4 py-1 text-sm font-medium">
                  {time}
                </button>
              ))}
            </div>
