                    ...
                    <div className="container mx-auto px-4">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                                Solusi Hukum Modern utk Era Digital
                            </h1>
                            <p className="text-xl text-gray-300">
                                Menghubungkan kamu dgn pengacara terbaik utk semua kebutuhan hukum
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    >
                        ...
                        <div className="text-gray-300 space-y-4">
                            <p>
                                LegalTech adalah platform inovatif yg menghubungkan klien dgn pengacara profesional secara online. Kami percaya bahwa akses ke layanan hukum hrs mudah, transparan & terjangkau utk semua.
                            </p>
                            <p>
                                Dgn teknologi modern & tim pengacara berpengalaman, kami menyediakan solusi hukum yg efektif & efisien utk berbagai kebutuhan, mulai dari konsultasi bisnis hingga penanganan kasus.
                            </p>
                        </div>
