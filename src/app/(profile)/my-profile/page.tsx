                                            ...
                                            <div className="space-y-4">
                                                {savedArticles.slice(0, 2).map((article) => (
                                                    <Link
                                                        ...
                                                        className="bg-slate-600 rounded-xl overflow-hidden flex items-center gap-4 hover:bg-slate-500 transition-colors"
                                                    >
                                            ...
                                            >
                                                ...
                                                <span className={`px-3 py-1 rounded-lg text-xs font-medium ${
                                                    ...
                                                    {consultation.status === "completed" ? "Selesai" :
                                                     consultation.status === "upcoming" ? "Akan Datang" : "Dibatalkan"}
                                                </span>
                                            </div>
                                        ))}
                                    </motion.div>
